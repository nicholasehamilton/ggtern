...
.element_tree <- find_global(".element_tree")
.el_def       <- find_global("el_def")

#TERNARY OPTIONS.
.element_tree$ternary.options = .el_def("element_ternary","") #

##TERNARY PANEL
.element_tree$panel.background.tern <- .el_def("element_rect", "rect")

##AXIS ARROWS
.element_tree$axis.tern         = .el_def("element_line", "line") #
.element_tree$axis.tern.arrow   = .el_def("element_line", "axis.tern") #
.element_tree$axis.tern.arrow.T = .el_def("element_line", "axis.tern.arrow") #
.element_tree$axis.tern.arrow.L = .el_def("element_line", "axis.tern.arrow") #
.element_tree$axis.tern.arrow.R = .el_def("element_line", "axis.tern.arrow") #
.element_tree$axis.tern.line    = .el_def("element_line", "axis.tern") #
.element_tree$axis.tern.line.T  = .el_def("element_line", "axis.tern.line") #
.element_tree$axis.tern.line.L  = .el_def("element_line", "axis.tern.line") #
.element_tree$axis.tern.line.R  = .el_def("element_line", "axis.tern.line") #
.element_tree$axis.tern.text    = .el_def("element_text", "text") #
.element_tree$axis.tern.text.T  = .el_def("element_text", "axis.tern.text") #
.element_tree$axis.tern.text.L  = .el_def("element_text", "axis.tern.text") #
.element_tree$axis.tern.text.R  = .el_def("element_text", "axis.tern.text") #
.element_tree$axis.tern.arrow.text     = .el_def("element_text", "axis.tern.text") #
.element_tree$axis.tern.arrow.text.T   = .el_def("element_text", "axis.tern.arrow.text") #
.element_tree$axis.tern.arrow.text.L   = .el_def("element_text", "axis.tern.arrow.text") #
.element_tree$axis.tern.arrow.text.R   = .el_def("element_text", "axis.tern.arrow.text") #
.element_tree$axis.tern.title          = .el_def("element_text", "axis.tern.text")#
.element_tree$axis.tern.title.T        = .el_def("element_text", "axis.tern.title")#
.element_tree$axis.tern.title.L        = .el_def("element_text", "axis.tern.title")#
.element_tree$axis.tern.title.R        = .el_def("element_text", "axis.tern.title")#

.element_tree$axis.tern.ticks          = .el_def("element_line", "axis.tern")#
.element_tree$axis.tern.ticks.major    = .el_def("element_line", "axis.tern.ticks")#
.element_tree$axis.tern.ticks.major.T  = .el_def("element_line", "axis.tern.ticks.major")#
.element_tree$axis.tern.ticks.major.L  = .el_def("element_line", "axis.tern.ticks.major")#
.element_tree$axis.tern.ticks.major.R  = .el_def("element_line", "axis.tern.ticks.major")#

.element_tree$axis.tern.ticks.minor    = .el_def("element_line", "axis.tern.ticks")#
.element_tree$axis.tern.ticks.minor.T  = .el_def("element_line", "axis.tern.ticks.minor")#
.element_tree$axis.tern.ticks.minor.L  = .el_def("element_line", "axis.tern.ticks.minor")#
.element_tree$axis.tern.ticks.minor.R  = .el_def("element_line", "axis.tern.ticks.minor")#

.element_tree$panel.grid.tern          = .el_def("element_line", "axis.tern") #
.element_tree$panel.grid.tern.major    = .el_def("element_line", "panel.grid.tern") #
.element_tree$panel.grid.tern.major.T  = .el_def("element_line", "panel.grid.tern.major") #
.element_tree$panel.grid.tern.major.L  = .el_def("element_line", "panel.grid.tern.major") #
.element_tree$panel.grid.tern.major.R  = .el_def("element_line", "panel.grid.tern.major") #

.element_tree$panel.grid.tern.minor    = .el_def("element_line", "panel.grid.tern") #
.element_tree$panel.grid.tern.minor.T  = .el_def("element_line", "panel.grid.tern.minor") #
.element_tree$panel.grid.tern.minor.L  = .el_def("element_line", "panel.grid.tern.minor") #
.element_tree$panel.grid.tern.minor.R  = .el_def("element_line", "panel.grid.tern.minor") #
